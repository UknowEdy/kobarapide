      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <div className="bg-koba-card p-8 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleRegister} className="space-y-3 max-h-96 overflow-y-auto pr-2">
            ...
            <div>
              <label className="block text-koba-text mb-1 text-sm">Mot de passe * (min. 6 caractères)</label>
              <input
                type="password"
            ...
            <div>
              <label className="block text-koba-text mb-1 text-sm">Confirmer mot de passe *</label>
              <input
                type="password"
